...
public class HelperHbmConfigInitializer {
  ...
  public static SessionFactory initializeHibernateSessionAutoAnnotate(File cfg) {
    ...
    .addAnnotatedClass(LipidmapsMetaboliteCrossreferenceEntity.class)
    .addAnnotatedClass(LipidmapsMetaboliteEntity.class)
    
    .addAnnotatedClass(HmdbMetaboliteOntology.class)
    .addAnnotatedClass(HmdbMetaboliteCrossreferenceEntity.class)
    .addAnnotatedClass(HmdbMetaboliteEntity.class);
