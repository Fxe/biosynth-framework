...
//				remove dr:
	...
	@Override
	public KeggGlycanMetaboliteEntity getMetaboliteInformation(Serializable id) {
...
//		System.out.println(parser.getTabs());
	...
	@Override
	public KeggGlycanMetaboliteEntity saveMetaboliteInformation(
