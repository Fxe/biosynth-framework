...
public class BetterNaiveReactionStrategy extends LesserNaiveReactionStrategy {
  ...
  private int maxMatrixSize = 4000;
  ...
  public int getMaxMatrixSize() { return maxMatrixSize;}
  public void setMaxMatrixSize(int maxMatrixSize) { this.maxMatrixSize = maxMatrixSize;}
